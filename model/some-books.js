...
SomeBooks.germanBooks = [
    new book_1.Book('9783864907791', 'Angular', ['Ferdinand Malcher', 'Johannes Hoppe', 'Danny Koppenhagen'], new Date('2020-09-01T00:00:00.000Z'), 'Grundlagen, fortgeschrittene Themen und Best Practices – inkl. RxJS, NgRx & PWA (iX Edition)', 5, [
...
• HTTP-Interceptoren`),
    new book_1.Book('9783864903571', 'Angular', ['Gregor Woiwode', 'Ferdinand Malcher', 'Danny Koppenhagen', 'Johannes Hoppe'], new Date('2017-05-22T12:00:00.000Z'), 'Grundlagen, fortgeschrittene Techniken und Best Practices mit TypeScript - ab Angular 4, inklusive NativeScript und Redux', 2, [
...
Nach der Lektüre sind Sie für den Projektalltag mit Angular gewappnet und können robuste Webanwendungen damit entwickeln.`),
    new book_1.Book('9783864905520', 'React', ['Nils Hartmann', 'Oliver Zeigermann'], new Date('2019-12-12T00:00:00.000Z'), 'Grundlagen, fortgeschrittene Techniken und Praxistipps – mit TypeScript und Redux', 3, [
        new book_1.Thumbnail('https://api4.angular-buch.com/images/react.jpg', 'Front Cover'),
        new book_1.Thumbnail('https://api4.angular-buch.com/images/react_back.jpg', 'Rückseite')
...
• GraphQL-Clients mit React`),
    new book_1.Book('9783960090922', 'Vue.js', ['Lars Peterke'], new Date('2019-02-28T00:00:00.000Z'), 'kurz & gut', 3, [new book_1.Thumbnail('https://api4.angular-buch.com/images/vue.jpg', 'Front Cover')], `• kompakte Einführung für alle, die sich rasch in das beliebte JavaScript-Framework einarbeiten möchten
...
Mit diesem Buch erhalten Entwickler einen kompakten und schnellen Überblick über den Funktionsumfang von Vue.js. Es behandelt unter anderem: die Grundlagen von Vue.js, Vue Components sowie alle Aspekte der Vue-API. Trotz seines kompakten Formats deckt das Taschenbuch viele weitere Themen ab, die für Entwickler relevant sind, wie die Umsetzung komplexerer Vue-Projekte mit Vue CLI, Single File Components und Transitions.`),
    new book_1.Book('9783864906497', 'Git', ['René Preißel', 'Bjørn Stachmann'], new Date('2019-08-22T00:00:00.000Z'), 'Dezentrale Versionsverwaltung im Team – Grundlagen und Workflows', 4, [
        new book_1.Thumbnail('https://api4.angular-buch.com/images/git.jpg', 'Front Cover'),
        new book_1.Thumbnail('https://api4.angular-buch.com/images/git_back.jpg', 'Rückseite')
